...
- **T3 vs T4**: T3 ships with every clone of this repo. T4 may or may not be installed. Asking before T4 use is what prevents "I cleared my `~/.agents/skills/` and now QA is broken" support tickets.
