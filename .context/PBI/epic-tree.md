...
- [BK-2](https://jira.upexgalaxy.com/browse/BK-2) Authentication | Sign up and sign in with email magic-link _(- pts, Ready For Release)_
- [BK-3](https://jira.upexgalaxy.com/browse/BK-3) Authentication | Sign up and sign in via OAuth (GitHub / Google) _(- pts, QA Approved)_
- [BK-4](https://jira.upexgalaxy.com/browse/BK-4) TMS-Workspace | Create a workspace _(- pts, Ready For Release)_
- [BK-5](https://jira.upexgalaxy.com/browse/BK-5) TMS-Workspace | Invite a teammate with a role _(- pts, Ready For Release)_
- [BK-6](https://jira.upexgalaxy.com/browse/BK-6) TMS-Workspace | Switch between workspaces _(- pts, Ready For Release)_
...
- [BK-10](https://jira.upexgalaxy.com/browse/BK-10) TMS-Module | Rename and soft-delete a module _(- pts, Ready For Release)_
- [BK-11](https://jira.upexgalaxy.com/browse/BK-11) TMS-Module | Move a module to a different parent _(- pts, Ready For Release)_
...
- [BK-14](https://jira.upexgalaxy.com/browse/BK-14) TMS-US | Manage user stories anchored to a module _(- pts, QA Approved)_
- [BK-15](https://jira.upexgalaxy.com/browse/BK-15) TMS-AC | Manage criteria under a user story _(- pts, Ready For Release)_
- [BK-16](https://jira.upexgalaxy.com/browse/BK-16) Markdown Editor | Write and preview Markdown safely _(- pts, Ready For Release)_
- [BK-17](https://jira.upexgalaxy.com/browse/BK-17) Jira Import | Pull Jira issues by JQL _(- pts, Ready For Release)_
...
- [BK-27](https://jira.upexgalaxy.com/browse/BK-27) TMS-Test Builder | Assemble a test by chaining ATCs _(- pts, Ready For Release)_
- [BK-28](https://jira.upexgalaxy.com/browse/BK-28) TMS-Test Builder | Reorder ATCs inside a test _(- pts, Ready For Release)_
- [BK-32](https://jira.upexgalaxy.com/browse/BK-32) TMS-Test View | View a test with all chained ATCs expanded _(- pts, Ready For Release)_
- [BK-33](https://jira.upexgalaxy.com/browse/BK-33) TMS-Test Tags | Assign reserved and custom tags to a test _(- pts, Ready For Release)_
...
- [BK-86](https://jira.upexgalaxy.com/browse/BK-86) Account | View my identity, role, and sign out _(- pts, Ready For Release)_
- [BK-87](https://jira.upexgalaxy.com/browse/BK-87) Settings | Open a settings hub and view my account _(- pts, Ready For QA)_
- [BK-88](https://jira.upexgalaxy.com/browse/BK-88) Settings | Manage Personal Access Tokens _(- pts, Ready For QA)_
- [BK-89](https://jira.upexgalaxy.com/browse/BK-89) TMS-Workspace | View the workspaces I belong to _(- pts, Ready For QA)_
- [BK-90](https://jira.upexgalaxy.com/browse/BK-90) TMS-Workspace | Leave a workspace _(- pts, Ready For QA)_

## [BK-183](https://jira.upexgalaxy.com/browse/BK-183) - QA Defect Management

**Status:** Backlog | **Stories:** 1 | **Points:** 0

- [BK-262](https://jira.upexgalaxy.com/browse/BK-262) PAT | Enforce capability scopes on every non-ATC route _(- pts, Shift-Left QA)_
...
- [BK-215](https://jira.upexgalaxy.com/browse/BK-215) Team Chat | Chat with workspace members in a real-time channel _(- pts, Backlog)_
...
- [BK-219](https://jira.upexgalaxy.com/browse/BK-219) Team Chat | Edit and delete my own messages _(- pts, Estimation)_
...
- [BK-229](https://jira.upexgalaxy.com/browse/BK-229) Billing | View my workspace plan, seats, and usage _(- pts, Backlog)_
- [BK-230](https://jira.upexgalaxy.com/browse/BK-230) Billing | Upgrade to a paid plan _(- pts, Backlog)_
