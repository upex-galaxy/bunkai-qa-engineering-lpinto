...
# EPIC [https://jira.upexgalaxy.com/browse/BK-12#icft=BK-12](https://jira.upexgalaxy.com/browse/BK-12#icft=BK-12) — User Stories & Acceptance Criteria
...
| --- | ----- | ------ | -------- | ------ |
| [BK-14](https://jira.upexgalaxy.com/browse/BK-14) | TMS-US | Manage user stories anchored to a module | - | Medium | QA Approved |
| [BK-15](https://jira.upexgalaxy.com/browse/BK-15) | TMS-AC | Manage criteria under a user story | - | Medium | Ready For Release |
| [BK-16](https://jira.upexgalaxy.com/browse/BK-16) | Markdown Editor | Write and preview Markdown safely | - | Medium | Ready For Release |
| [BK-17](https://jira.upexgalaxy.com/browse/BK-17) | Jira Import | Pull Jira issues by JQL | - | Medium | Ready For Release |
