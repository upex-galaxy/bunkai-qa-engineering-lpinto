...
- The Runs domain ([https://jira.upexgalaxy.com/browse/BK-30#icft=BK-30](https://jira.upexgalaxy.com/browse/BK-30#icft=BK-30), Manual Execution & Runs) has shipped functional read/write paths for run creation, step marking, abort, finish, per-project reporting, and per-test history.
- The Bugs domain ([https://jira.upexgalaxy.com/browse/BK-31#icft=BK-31](https://jira.upexgalaxy.com/browse/BK-31#icft=BK-31), Bugs & Defect Heatmap) has no shipped read surface yet — [https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40) (file a defect) is in progress and [https://jira.upexgalaxy.com/browse/BK-41#icft=BK-41](https://jira.upexgalaxy.com/browse/BK-41#icft=BK-41)/42/43 have not started.
- The Coverage domain ([https://jira.upexgalaxy.com/browse/BK-44#icft=BK-44](https://jira.upexgalaxy.com/browse/BK-44#icft=BK-44), Coverage & Traceability) has one shipped building block ([https://jira.upexgalaxy.com/browse/BK-49#icft=BK-49](https://jira.upexgalaxy.com/browse/BK-49#icft=BK-49), the activity stream) but the coverage-percentage surfaces ([https://jira.upexgalaxy.com/browse/BK-46#icft=BK-46](https://jira.upexgalaxy.com/browse/BK-46#icft=BK-46), [https://jira.upexgalaxy.com/browse/BK-47#icft=BK-47](https://jira.upexgalaxy.com/browse/BK-47#icft=BK-47)) have not started.
...
| [BK-259](https://jira.upexgalaxy.com/browse/BK-259) | TMS-Home | Show workspace test coverage summary | - | Medium | Ready For QA |
| [BK-260](https://jira.upexgalaxy.com/browse/BK-260) | TMS-Home | Show a condensed recent activity feed | - | Medium | Ready For QA |
